...
comment on column usersInfo.ieChat is '微信号';
comment on column usersInfo.adCard is '身份证号';
comment on column usersInfo.wddress is '住址';
...
insert into usersInfo
(usersId,deptsId,loginName,loginPwd,name,sex,age,phone,idCard,weChat,address,isDelete,isEnable,createUser,lastUpdateUser) 
values(S_usersInfo.Nextval,1,'ceshi1','888','测试员1','y',26,'15235616582','530665199612303698','m953903943','北京',0,1,S_usersInfo.Currval,S_usersInfo.Currval);
insert into usersInfo
(usersId,deptsId,loginName,loginPwd,name,sex,age,phone,idCard,weChat,address,isDelete,isEnable,createUser,lastUpdateUser) 
values(S_usersInfo.Nextval,1,'ceshi2','888','测试员2','x',26,'15235616582','530665199612303698','m953903943','重庆',1,1,S_usersInfo.Currval,S_usersInfo.Currval);
insert into usersInfo
(usersId,deptsId,loginName,loginPwd,name,sex,age,phone,idCard,weChat,address,isDelete,isEnable,createUser,lastUpdateUser) 
values(S_usersInfo.Nextval,1,'ceshi3','888','测试员3','y',26,'15235616582','530665199612303698','m953903943','英格兰',0,1,S_usersInfo.Currval,S_usersInfo.Currval);
insert into usersInfo
(usersId,deptsId,loginName,loginPwd,name,sex,age,phone,idCard,weChat,address,isDelete,isEnable,createUser,lastUpdateUser) 
values(S_usersInfo.Nextval,1,'ceshi4','888','测试员4','x',26,'15235616582','530665199612303698','m953903943','山东',0,1,S_usersInfo.Currval,S_usersInfo.Currval);
insert into usersInfo
(usersId,deptsId,loginName,loginPwd,name,sex,age,phone,idCard,weChat,address,isDelete,isEnable,createUser,lastUpdateUser) 
values(S_usersInfo.Nextval,1,'ceshi5','888','测试员5','y',26,'15235616582','530665199612303698','m953903943','东北',0,1,S_usersInfo.Currval,S_usersInfo.Currval);
insert into usersInfo
(usersId,deptsId,loginName,loginPwd,name,sex,age,phone,idCard,weChat,address,isDelete,isEnable,createUser,lastUpdateUser) 
values(S_usersInfo.Nextval,1,'ceshi6','888','测试员6','y',26,'15235616582','530665199612303698','m953903943','米国',0,1,S_usersInfo.Currval,S_usersInfo.Currval);
commit;
--select * from usersInfo;
--delete from usersInfo; 
--delete from usersInfo where usersid = 61;
